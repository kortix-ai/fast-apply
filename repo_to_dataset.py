...
def main():
    ...
    parser.add_argument('--sample-1000-1999', type=int, default=2000, help='Number of samples for files with 1000-1999 tokens')
    parser.add_argument('--sample-2000-2999', type=int, default=1000, help='Number of samples for files with 2000-2999 tokens')
    parser.add_argument('--sample-3000-3999', type=int, default=500, help='Number of samples for files with 3000-3999 tokens')
